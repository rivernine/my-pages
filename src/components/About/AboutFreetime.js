            ...
            <GridItem colSpan={10}>
              <Flex flexDir={"column"}>
                ...
                <Text mt="15px" color="white" fontWeight={400}>
                  ...
                  2021년 4월부터 시작하여 지금까지 7개의 사이드 프로젝트를 진행하고 있으며 2000회 이상의 commit을 했습니다. (2023년 1월 기준)
                </Text>
                <HStack mt="30px" spacing="100px">
                  <VStack spacing="15px">
                    ...
                    <Flex w="550px" alignItems={"center"}>
                      ...
                      <Text fontSize={"sm"} fontWeight={400} color="white">
                        <span style={{ fontWeight: 700 }}>Ticker Picker.</span> 최적의 주식 트레이딩 전략 추천 및 자동매매 봇
                      </Text>
                    </Flex>
                    ...
                    <Flex w="550px" alignItems={"center"}>
                      ...
                      <Text fontSize={"sm"} fontWeight={400} color="white">
                        <span style={{ fontWeight: 700 }}>Crypto-Generator.</span> 업비트, 바이낸스 거래소의 코인 자동매매 봇
                      </Text>
                    </Flex>
